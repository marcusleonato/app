System.register(['angular2/core', './product.service', './orderBy', 'angular2/router', './product-detail.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, product_service_1, orderBy_1, router_1, product_detail_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            AppComponent = (function () {
                function AppComponent(_productService, router) {
                ...
                AppComponent.prototype.onClick = function (productId) {
                    ...
                    router_1.RouteConfig([
                        {
                            ...
                            component: product_detail_component_1.ProductDetail,
                            name: "ProductDetail",
                        }
                    ]), 
